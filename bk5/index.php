        ...
        <div class="flex">
            ...
            <div class="mb-menu">
                <div class="mb-menu-inner flex split3">
                    <div class="mb-menu-button split flex _middle _center" data-name="agency">icon<br>代理店</div>
                    <div class="mb-menu-button split flex _middle _center" data-name="incentive">icon<br>インセンティブ</div>
                    <div class="mb-menu-button split flex _middle _center" data-name="config">icon<br>設定</div>
                </div>
            </div>
            <!--↑menu-->
            <!--↓content-->
