    <div class="split change-agreement" data-change='<?= $link_agency;?>'>
        <a class="total active" id="total">
            ...
            <p><?= month(-1);?>月契約数：<?= $calc_month_1;?>回線 / <?= month(0);?>月契約数：<?= $calc_month;?>回線</p>
        </a>
    </div>
    <div class="split">
        <a class="genkai" id="genkai">
            ...
            <p><?= month(-1);?>月契約数：<?= $calc_wifi_month_1;?>回線 / <?= month(0);?>月契約数：<?= $calc_wifi_month;?>回線</p>
        </a>
    </div>
    <div class="split">
        <a class="sim" id="sim">
            ...
            <p><?= month(-1);?>月契約数：<?= $calc_sim_month_1;?>回線 / <?= month(0);?>月契約数：<?= $calc_sim_month;?>回線</p>
        </a>
    </div>
    <div class="split">
        <a class="sugoi" id="sugoi">
            ...
            <p><?= month(-1);?>月契約数：<?= $calc_sugoi_month_1;?>回線 / <?= month(0);?>月契約数：<?= $calc_sugoi_month;?>回線</p>
        </a>
    </div>
    <div class="split">
